 ...
 * @author Lenovo
 */
public class OperatorTan extends AbstractOperator{
    @Override
    public final CalcNumber evaluate(CalcNumber left, CalcNumber right) {
        throw new UnsupportedOperationException("Tan operation does not accept two values!");
    }
    @Override
    public final CalcNumber evaluate(CalcNumber val) {
        return new CalcNumber(Math.tan(val.getValue()));
    }
    @Override
