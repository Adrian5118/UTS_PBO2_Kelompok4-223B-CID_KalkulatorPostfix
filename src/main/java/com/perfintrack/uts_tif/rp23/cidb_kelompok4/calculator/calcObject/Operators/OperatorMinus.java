 ...
 * @author Lenovo
 */
public class OperatorMinus extends AbstractOperator{
    @Override
    public final CalcNumber evaluate(CalcNumber left, CalcNumber right) {
        return new CalcNumber(left.getValue() - right.getValue());
    }
    @Override
    public final CalcNumber evaluate(CalcNumber val) {
        throw new UnsupportedOperationException("Minus operation does not accept only one value!");
    }
    @Override
