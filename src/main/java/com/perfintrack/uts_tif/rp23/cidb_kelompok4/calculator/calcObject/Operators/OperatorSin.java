 ...
 * @author Lenovo
 */
public class OperatorSin extends AbstractOperator{
    @Override
    public final CalcNumber evaluate(CalcNumber left, CalcNumber right) {
        throw new UnsupportedOperationException("Sine operation does not accept two values!");
    }
    @Override
    public final CalcNumber evaluate(CalcNumber val) {
        return new CalcNumber(Math.sin(val.getValue()));
    }
    @Override
